...
<body>
	...
	<header>
	  <div id="logo">
		<div id="logo_text">
		<h1><a href="<?php echo getLink('news'); ?>">Tornadia<span class="logo_colour">AAC</span></a></h1>
		<h2>Awesome oldskool!</h2>
		</div>
	</div>
	<nav>
	...
	<footer>
		<p><?php echo template_footer(); ?> ( <a href="http://www.css3templates.co.uk">design from css3templates.co.uk</a> )</p>
	</footer>
	</div>
